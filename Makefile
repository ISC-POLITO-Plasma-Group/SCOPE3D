...
#else
F90= mpipgifort
EXE= ./pgi_turbo_rec_cpu.x
#endif

FFLAGS =  -O2 -g -c -Mpreprocess -Minfo=accel -Mcuda
LNKFLAGS = -Minfo=accel -I/cineca/prod/opt/compilers/hpc-sdk/2021/binary/Linux_ppc64le/21.5/cuda/11.3/include -L/cineca/prod/opt/compilers/hpc-sdk/2021/binary/Linux_ppc64le/21.5/cuda/11.3/lib64 -cudalib=cusparse -lnvToolsExt
